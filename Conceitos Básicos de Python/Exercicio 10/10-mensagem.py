...
e-mail = 'brazil@pyladies.com'

print (f'Olá {nome}, você está com {idade} e reside no estado de {estado}. Envie um e-mail para {e-mail} e saiba mais informações sobre o grupo PyLadies, um grupo com o propósito de ajudar mais e mais mulheres a se tornarem participantes ativas e líderes na comunidade open source Python' )